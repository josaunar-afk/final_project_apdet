...
">
    ...
    <style>
        ...
        .save-btn:hover { background: #ff5e7e; transform: translateY(-2px); box-shadow: 0 0 25px rgba(255, 45, 85, 0.5); }

        .error-box { background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.2); color: #f87171; padding: 16px; border-radius: 12px; margin-bottom: 24px; font-size: 0.9rem; }
        ...
        [data-bs-theme="light"] .error-box { background: #fee2e2; color: #b91c1c; border-color: #fca5a5; }
        ...
        <div class="cin-card">
            ...
            <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="cin-group">
                    ...
                    <input type="text" name="title" class="cin-input" value="{{ old('title') }}" required placeholder="Enter project name">
                </div>

                <div class="cin-group">
                    <label class="cin-label">Description</label>
                    <textarea name="description" class="cin-textarea" rows="5" required placeholder="Describe your masterpiece...">{{ old('description') }}</textarea>
                </div>

                <div class="cin-group">
                    <label class="cin-label">Project Link (Optional)</label>
                    <input type="url" name="project_link" class="cin-input" value="{{ old('project_link') }}" placeholder="https://example.com">
                </div>

                <div class="cin-group" style="margin-bottom: 40px;">
                    <label class="cin-label">Upload Image</label>
